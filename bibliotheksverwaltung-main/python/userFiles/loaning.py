...
class LoaningClass:
    ...
    def open_window(self, user_id):
        ...
        ttk.Button(filter_frame, text="Buch zurückgeben",
                   command=lambda: self.return_book.open_window(user_id)).pack(side="right")
        ...
        self.books = self.showOwnLoans(user_id)
